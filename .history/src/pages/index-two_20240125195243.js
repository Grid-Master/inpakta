  ...
  const workData = [
    {
      ...
      desc: 'Вы предоставляете людям услуги? Ваша прибыль зависит от количества клиентов? Мы поможем увеличить вашу прибыль',
    },
    {
      icon: 'mdi mdi-wallet-outline',
      title: 'Создать свой магазин',
      desc: 'Ваша задача - собирать заказы. Наша задача - Создать вам магазин - привлечь клиентов - следить за рекламой - предоставлять вам аналитику успеха вашего магазина - генерировать вам отчет о доходах недели, месяца, года',
    },
    {
      icon: 'mdi mdi-home-plus-outline',
      title: 'Реализовать твою идею или стартап',
      desc: 'Мы поможем привлечь инвестиции, Реализовать ваш стартап',
    },
  ];
  return (
    <>
      ...
      <section className="relative table w-full lg:py-40 md:py-36 pt-36 pb-24 overflow-hidden bg-white dark:bg-slate-900">
        <div className="container relative z-1">
          <div className="relative grid lg:grid-cols-12 grid-cols-1 items-center mt-10 gap-[5px]">
            <div className="lg:col-span-8">
              <div className="lg:me-6 lg:text-start text-center">
                <h1 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-6xl mb-5">
                  До создания своего
                  <br /> бизнеса один клик.
                </h1>
                <p className="text-lg max-w-xl lg:ms-0 mx-auto">
                  Создать проект проще, чем создать страницу в Инстаграм. Введи адрес своей
                  электронной почты и уже завтра у тебя будет свой проект.
                </p>
                  ...
                  <form className="relative max-w-md mx-auto lg:ms-0">
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="support@inpakta.com"
                      />
                    </div>
                    <button
                      type="submit"
        ...
        <div className="container relative md:mt-24 mt-16">
          <div className="grid grid-cols-1 pb-6 text-center">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              Хочешь создать или усовершенствовать свой бизнес? Привлечь новых клиентов? Команда
              специалистов с большим опытом поможет тебе в один клик.
            </p>
          </div>
            ...
            {workData.map((item, index) => {
              return (
                <div className="relative p-6" key={index}>
                  <i
                    className={`${item.icon} bg-gradient-to-tl to-amber-400 from-fuchsia-600 text-transparent bg-clip-text text-[45px]`}></i>
