          ...
          <div className="p-6 bg-gray-50 dark:bg-slate-800">
            <ul className="list-none text-slate-400">
              ...
              <li className="flex items-center mt-2 text-slate-400">
                <AiOutlineClose className="h-[18px] w-[18px] me-2" /> 2.5M+ standard media
              </li>
              <li className="flex items-center mt-2 text-slate-400">
                <AiOutlineClose className="h-[18px] w-[18px] me-2" /> iStock
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-800">
          ...
          <div className="p-6 bg-gray-50 dark:bg-slate-800">
            <ul className="list-none text-slate-400">
              ...
              <li className="flex items-center mt-2">
                <FiCheckCircle className="text-green-600 h-[18px] w-[18px] me-2" />{' '}
                <span className="text-slate-900 dark:text-white me-1 font-semibold">100 GB</span>{' '}
                storage
              </li>
              <li className="flex items-center mt-2">
                <FiCheckCircle className="text-green-600 h-[18px] w-[18px] me-2" />{' '}
              ...
              <li className="flex items-center mt-2">
                <FiCheckCircle className="text-green-600 h-[18px] w-[18px] me-2" />{' '}
                <span className="text-slate-900 dark:text-white me-1 font-semibold">40/mo</span>{' '}
                iStock
              </li>
            </ul>
          </div>
