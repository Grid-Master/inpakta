...
export default function AiFeatures() {
  const featureData = [
    ...
    {
      icon: FiLifeBuoy,
      title: 'Отчеты бизнеса',
      desc: 'Решение всегда строится на отчете. Система IMPAKTA AKTIV формирует финансовые отчеты прямо в личном кабинете или отсылает вашему бухгалтеру на почту.',
    },
  ];
  return (
    <>
